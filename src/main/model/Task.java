...
public class Task extends Todo {
    ...
    public void addTag(String tagName) {
        ...
        if (tagName.length() == 0) {
            throw new EmptyStringException("Tag name cannot be empty.");
        }
    ...
    public String toString() {
        ...
        output.append("\n\tTags: " + tagsToString(new ArrayList<>(getTags())));
        output.append("\n}");
    ...
    public boolean equals(Object o) {
        ...
        if  (Objects.equals(this.description, task.description)) {
            if (Objects.equals(this.dueDate, task.dueDate)) {
                if (Objects.equals(this.getPriority(), task.getPriority())) {
    ...
    //EFFECTS: returns the hashCode of this task
    @Override
    public int hashCode() {
        // return Objects.hash(description, tags, dueDate, priority, status);
        return Objects.hash(description, dueDate, this.getPriority(), status);
    }
    ...
    //EFFECTS: returns the progress of this task
    @Override
    ...
    public void setEstimatedTimeToComplete(int hours) {
        if (hours < 0) {
            throw new NegativeInputException("Cannot have a negative hour!");
        }
        this.etcHours = hours;
    }
    ...
    //MODIFIES: this
    //EFFECTS: sets the progress of this task
    // throws an InvalidProgressException if REQUIRES clause is not satisfied
    ...
    public void setProgress(int progress) {
        ...
        if (progress > 100) {
            throw new InvalidProgressException("TOO BIG BOI");
        }
